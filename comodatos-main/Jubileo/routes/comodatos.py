    ...
    try:
        ...
        for comodato_rec, cliente_rec in comodatos_con_clientes: 
            ...
            lista_comodatos.append({
                ...
                'No. Inventario': comodato_rec.Inventario if comodato_rec.Inventario else 'N/A',
                'Caracteristicas': comodato_rec.Caracteristicas if comodato_rec.Caracteristicas else 'N/A',
...
def descargar_excel():
    ...
    try:
        ...
        headers = [
            ...
            'Fecha Devolución', 'Folio Sustitución', 'Cantidad', 'UM', 'Concepto','No. Inventario',
            'Caracteristicas','Costo', 'Importe', 'Importe Total'
        ]
...
def editar_comodato(idComodato):
    ...
    if request.method == 'POST':
        try:
            ...
            comodato.Inventario = request.form['Inventario']
            comodato.Caracteristicas= request.form['Caracteristicas']
